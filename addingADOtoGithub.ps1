...
Write-Host ' - - - - - - - - - - - - - - - - - - - - - - - - - '
$AzureRepoName = "Project-Test-Writing-Cypress"
$ADOCloneURL = "nfocus.visualstudio.com/DefaultCollection/TODO%20Intake%204/_git/Project-Test-Writing-Cypress.git"
$GitHubCloneURL = "github.com/Nethmaw/Project-Test-Writing-.git"
